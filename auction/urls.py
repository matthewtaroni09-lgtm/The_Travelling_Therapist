...
urlpatterns = [
    ...
    path("casual_work", views.casual_work, name="casual-work"),
    ...
    path("platform-updates/v10-0", views.update_v10_0, name="update-v10-0"),
    path("platform-updates/v9-0", views.update_v9_0, name="update-v9-0"),
    path("platform-updates/v8-0", views.update_v8_0, name="update-v8-0"),
    path("platform-updates/v7-0", views.update_v7_0, name="update-v7-0"),
