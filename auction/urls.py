...
urlpatterns = [
    ...
    path("create_auction_hourly", views.create_auction_hourly, name="create-auction-hourly"),
    path("register", views.register, name="register"),
    path("login", views.login_user, name="login"),
    path('logout_user', views.logout_user, name="logout"),
    path('auction/<auction_id>', views.view_auction, name="auction"),
    path('auction_hourly/<auction_id>', views.view_auction_hourly, name="auction"),
