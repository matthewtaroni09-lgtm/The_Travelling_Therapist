...
urlpatterns = [
    ...
    path("clinic_owner_guide", views.clinic_owner_guide, name="clinic-owner-guide"),
    path("clinic_owner_guide_2", views.clinic_owner_guide_2, name="clinic-owner-guide-2"),
