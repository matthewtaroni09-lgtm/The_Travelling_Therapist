...
class Auction(models.Model):
    ...
    placementStart = models.DateField(verbose_name='Therapist Start Date', null=True, blank=True, help_text='Enter the start date of the placement.')
    placementEnd = models.DateField(verbose_name='Therapist End Date', null=True, blank=True, help_text='Enter the end date of the placement.')
